...
`0CTW.dylib` 和 `ctwsup.dylib` 均未修改；`offline6` 只在运行时调用经过偏移校验的
原 stub。
...
`offline6` 已从固定原包连续完成两次全量重建；deb、`fix.dylib`、主程序和
`CTW.dylib` 的 SHA256 均逐项一致。

## 7. 最终产物

```text
patched/560_CTW_Pro(无根版)_5.6.0-offline6_com.amg456.CTWPro.rootless560_deep_offline_ustar.deb
```

- Package: `com.amg456.CTWPro.rootless560`
- Version: `5.6.0-offline6`
- Size: `27,004,172` bytes
- SHA256: `e3d526485358ad62880c007ae518f20ecc3662d1ba058ad066f9b1edf0d1806e`

最终 Mach-O：

- `CTW Pro`: `32dbad98901177b8c627066d85b48d4df5e9a802995149218a8478f8a6ab6af7`
- `fix.dylib`: `e31ed7dfb790f8e68b2ef27c051c48c076211ffd9ee1523175c561f04ae3f510`
...
改机；`offline6` 的 NIB action、运行时注册点、原 apply 入口、本地 helper、三层配置
...
没有可用 root shell。因此尚未取得 `offline6` 点击后“零 `/vd`、缓存身份字段变化、
...
Package: com.amg456.CTWPro.rootless560
Version: 5.6.0-offline6
Filename: ./debs/com.amg456.CTWPro.rootless560_5.6.0-offline6_deep_offline_ustar.deb
Size: 27004172
SHA256: e3d526485358ad62880c007ae518f20ecc3662d1ba058ad066f9b1edf0d1806e
